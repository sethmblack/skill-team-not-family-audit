...
## Workflow
### Step 1: 1. Audit Current Language
...
### Step 2: 2. Identify Problem Patterns
...
### Step 4: 4. Recommend Team Alternatives
...
### Step 5: 5. Address Cultural Shift
...
**Immediate (this week):**
1. Have the conversation with this engineer. Not "you're fired" but "here are expectations, here's the timeline, here's what success looks like."
2. Give managers permission: "High standards are caring. Letting someone fail slowly is not kindness."

**Short-term (30 days):**
1. Audit other long-tenured underperformers. This is probably not the only one.
2. Train managers on performance conversations - guilt is often just lack of skill
3. Update cultural language: "championship team" instead of "family"

**Ongoing:**
1. Establish clear performance expectations for every role
2. Regular performance reviews that actually address issues
3. Celebrate departures when necessary: "This wasn't the right fit, and that's okay"
